...
public class AzureManagement {
	...
	public static void main(String[] args) {
		try {
			...
			final String MY_SUFFIX = "3phr"; // Add your suffix here
			...
			final String[] BLOB_CONTAINERS = { "images" };	// Containers to add to the blob storage
																					//TODO geo rep na asia
			final Region[] REGIONS = new Region[] { Region.EUROPE_WEST, Region.ASIA_EAST }; // Define the regions to deploy resources here
					...
					Thread th = new Thread(() -> {
						try {
							...
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "Reservations", "/id",
									null);
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "Messages", "/id",
									null);
